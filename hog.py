...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    rolls_count, points , pig_out = 0, 0, 0
    while rolls_count<num_rolls:
        current_outcome, rolls_count = dice(), rolls_count + 1
        points+= current_outcome
...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    return score0>1 and score1>1 and max(score0,score1) % min(score0,score1) == 0
    # END PROBLEM 4
...
def both(f, g):
    ...
    """
    # BEGIN PROBLEM 6
    return lambda s0,s1:both(f(s0, s1), g(s0, s1))
    # END PROBLEM 6
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    def commentary_func(score0,score1):
        if who:
             current_score= score1
        else:
             current_score=score0
        dif_point = current_score - previous_score
        if dif_point>previous_high:
            if dif_point == 1:
                print("1 point! That's the biggest gain yet for Player", who)
            else:
                print(dif_point, "points! That's the biggest gain yet for Player", who)
            return announce_highest(who,dif_point,current_score)
        return announce_highest(who,previous_high,current_score)
    return commentary_func
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    highest_avg, num_of_dice, i = 0, 1, 1
    while i <= 10:
        current_avg = make_averaged(roll_dice, num_samples)(i, dice)
        if highest_avg<current_avg:
            highest_avg, num_of_dice = current_avg, i
        i+=1
    return num_of_dice
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if (is_swap(score + free_bacon(opponent_score), opponent_score) or
                free_bacon(opponent_score) >= margin):
        return 0
    return num_rolls
    # END PROBLEM 11
